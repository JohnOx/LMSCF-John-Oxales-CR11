...
$sql = "SELECT * FROM animals where adopted = 'no' order by animalType asc";
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <form class="form-inline my-2 my-lg-0">
                    <input class="form-control mr-sm-2" type="search" placeholder="Search Dogs" aria-label="Search" id="search">
